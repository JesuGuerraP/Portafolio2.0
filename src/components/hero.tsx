    ...
    >
      ...
      <div className="container-tight relative z-10 px-4 pt-20">
        <div className="flex flex-col items-start gap-4 animate-fade-in">
          ...
          <div className="flex flex-row gap-2 sm:gap-4 w-full sm:w-auto mb-4 sm:mb-0">
            <Button asChild size="lg" className="btn-gradient group flex-1 sm:flex-none">
            ...
            <Button variant="outline" size="lg" asChild className="border-accent/20 hover:border-accent/50 hover:bg-accent/5 flex-1 sm:flex-none">
          ...
          {/* Icono para bajar a la sección "Sobre mí" */}
          <div className="flex justify-center w-full mt-4 animate-bounce z-50">
            <a 
              href="#about" 
              onClick={(e) => {
                e.preventDefault();
              ...
              className="inline-block p-2 text-accent hover:text-accent/80 transition-colors cursor-pointer"
